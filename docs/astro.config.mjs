...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        { label: 'Installation', collapsed: true, items: [{ autogenerate: { directory: 'installation' } }] },
        { label: 'Initialization', collapsed: true, items: [{ autogenerate: { directory: 'initialization' } }] },
        { label: 'Appear animations', collapsed: true, items: [{ autogenerate: { directory: 'animations/appear' } }] },
        { label: 'Text animations', collapsed: true, items: [{ autogenerate: { directory: 'animations/text' } }] },
        { label: 'Hover animations', collapsed: true, items: [{ autogenerate: { directory: 'animations/hover' } }] },
        { label: 'Components', collapsed: true, items: [{ autogenerate: { directory: 'animations/components' } }] },
        { label: 'Utilities', collapsed: true, items: [{ autogenerate: { directory: 'animations/utilities' } }] },
        { label: 'Recipes', collapsed: true, items: [{ autogenerate: { directory: 'recipes' } }] },
